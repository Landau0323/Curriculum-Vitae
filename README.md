...
- 社内セミナー講師のサーベイ・依頼（理研の瀧雅人氏・初田哲男氏・Enrico Rinaldi氏・Jeffrey Fawcett氏・青山秀明氏、オムロンの高橋氏）
- 顧客（製造業大手）の社員に対するAIレクチャーを2回実施(2019年10月)。内容は、semantic segmentationの理論的背景とビジョンピッキングロボットシステムでの活用、アノテーション作業実習、３Dデータ処理について。
...
職階:
研究開発本部 次長 (RoboSense部門担当)

- 3Dビジョンピッキングロボット[PoC・開発]
  - 2018年12月から2019年8月・2019年11月から2020年3月
...
- 3Dビジョンピッキングロボット[デモ]
  ...
  - 使用技術: python、semantic segmentation、ROS（アーム制御・信号入出力・順/逆運動学）、３Dデータ操作開発（点群のトリミング・ICP/RANSACによる円盤検出）
