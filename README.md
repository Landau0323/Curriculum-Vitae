...
- 似顔絵ロボット[デモ]
  ...
  - 担当した役割: アルゴリズム調査/考案/実装・ハードウェアおよびソフトウェアのプロトタイプ作成・ロボットメーカとの納品スケジュール調整・デモブース作成業者との調整・現地での作業・ライブ参加者対応
...
- 製薬工程（震蘯）自動化ロボット[開発]
  ...
  - 使用技術/ツール: P型軌道の編集（3次元ベクトルおよび四元数の粗視化・スプライン補間）、instance segmentation開発のマネージメント、データ分析（時系列データ、線形回帰）/python, C++, bCapslavemove, keras, scikit-learn
